              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" id="facstream" name="facstream" value="<?php echo $row['department']; ?>"
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="text" id="facname" name="facname" value="<?php echo $row['name']; ?>" class="form-control"
                      readonly>
                  </div>
                </div>
                <?php
